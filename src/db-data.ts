export const PROJECTS: any = [
...

    {
        id: 1,
        title: 'El Pollo Loco',
        imgUrl: '../../assets/img/project-epl2.jpg',
        ...
        keywords: 'JavaScript | OOP | HTML | CSS',
        category: 'JavaScript',
        webLink: 'https://yvonne-goetzeler.developerakademie.net/elpolloloco/',
        gitLink: 'https://github.com/yvgo/js-elPoloLoco',
    },
    {
        id: 2,
        title: 'JOIN',
        imgUrl: '../../assets/img/project-join.jpg',
        ...
        category: 'JavaScript',
        webLink: 'https://yvonne-goetzeler.developerakademie.net/join-me/',
    ...
    },
    {
        ...
        category: 'JavaScript',
        webLink: 'https://yvonne-goetzeler.developerakademie.net/pokemon/',
        gitLink: 'https://github.com/yvgo/js-pokemonWold',
    },
    {
        id: 4,
        title: 'Portfolio',
        imgUrl: '../../assets/img/portfolio-yg.jpg',
        longDescription: 'My Portfolio Page.',
        keywords: 'Angular | TypeScript | HTML | SCSS',
        category: 'Angular',
        webLink: '',
